...
- `src/data/store.ts` — `useAppStore()`: `userRole`, `isOnline`
- `src/app/router.tsx` — маршруты `/app/shelf` (view) и `/app/shelf-config` (admin edit)
...
Создать `docs/sessions/prompts/I-05-sweep-order.md`.
